...
DATA{1} = [1        17.71	17.71	17.71
            0.26	11.16	 6.68	19.29
...
%         10	10	10
%         10	9	10
%         9	10	10]; % each point is a pooled sample of X animals   % OR: 8 * ones(size(DATA{1})-1); 

%% Initial values for the state variables
% Initial states, scenarios in columns, states in rows. First row are the
% 'names' of all scenarios.

X0mat = [17.71   % the scenarios (here nominal concentrations) 
...
par.ke    = [0.04558    1 0 100 ];  % elimination rate constant, d-1 % Doesn't go above line when setting to 0
par.ku    = [1.810    1 1e-4 100 ];  % uptake rate constant, L/kg/d
