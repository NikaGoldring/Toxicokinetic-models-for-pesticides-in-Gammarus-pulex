...
%         10	9	10
%         10	10	10
%         9	10	8]; % each point is a pooled sample of X animals   % OR: 8 * ones(size(DATA{1})-1); 

%% Initial values for the state variables
% Initial states, scenarios in columns, states in rows. First row are the
% 'names' of all scenarios.

X0mat = [18.35   % the scenarios (here nominal concentrations) 
...
par.ku    = [2   1 0.01 1e6 1];  % uptake rate constant, L/kg/d
