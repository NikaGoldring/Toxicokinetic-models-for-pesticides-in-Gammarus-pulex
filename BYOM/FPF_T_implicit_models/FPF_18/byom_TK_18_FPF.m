...
%         10	10	10
%         10	10	10
%         10	10	10]; % each point is a pooled sample of X animals   % OR: 8 * ones(size(DATA{1})-1); 

%% Initial values for the state variables
% Initial states, scenarios in columns, states in rows. First row are the
% 'names' of all scenarios.

X0mat = [18.56   % the scenarios (here nominal concentrations) 
...
par.ke    = [0.1258    1 0.01 100 ];  % elimination rate constant, d-1
par.ku    = [1.382    1 0.01 100 ];  % uptake rate constant, L/kg/d
