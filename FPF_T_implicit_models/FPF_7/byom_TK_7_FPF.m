...
%modified by Annika Mangold-Doering 27.07.2020
...
%        10	10	9
%        10	10	10
%        10	10	10]; % each point is a pooled sample of X animals   % OR: X * ones(size(DATA{1})-1); 

%% Initial values for the state variables
% Initial states, scenarios in columns, states in rows. First row are the
% 'names' of all scenarios.

X0mat = [17.80   % the scenarios (here nominal concentrations) 
...
par.ke     = [   0.12574  1       0.01        100 1]; 
par.ku     = [    1.4148  1       0.01        100 1];
